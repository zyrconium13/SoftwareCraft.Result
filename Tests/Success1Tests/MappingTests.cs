...
public sealed class MappingTests
{
  ...
  public void Test7()
  {
    ...
    newResult.ShouldBeSameAs(expectedResult);
  }
  ...
  public void Test11()
  {
    var newResult = Result.Success<VioletIris>().SelectMany(e =>
                                                            {
                                                              errorSpy.Trip(e);
    ...
    newResult.ShouldBeOfType<Success<PinkLily>>();
  }
  ...
  public void Test14()
  {
    ...
    var newResult = Result.Error(new VioletIris()).SelectMany(e =>
                                                              {
                                                                errorSpy.Trip(e);
                                                                return expectedResult;
                                                              });
  ...
  public void Test2()
  {
    var newResult = Result.Success<VioletIris>().Select(() => { successSpy.Trip(); });

    successSpy.VerifyTrip(1);

    newResult.ShouldBeOfType<Success<VioletIris>>();
  }

  [Fact(DisplayName = "Success result does not call error map function")]
  public void Test3()
  {
    var newResult = Result.Success<VioletIris>().Select(e =>
                                                        {
                                                          errorSpy.Trip(e);
                                                          return new PinkLily();
                                                        });
  ...
  public void Test4()
  {
    ...
    newResult.Match(() => { }, e => e.ShouldBeSameAs(expectedOutput));
  }
  ...
  public void Test5()
  {
    ...
    var newResult = Result.Error(expectedInput).Select(e =>
                                                       {
                                                         errorSpy.Trip(e);
                                                         return expectedOutput;
                                                       });
    ...
    newResult.Match(() => { }, e => { e.ShouldBe(expectedOutput); });
  }

  [Fact(DisplayName = "Error result does not call success map function")]
  public void Test6()
  {
    var newResult = Result.Error(new VioletIris()).Select(() => { successSpy.Trip(); });
