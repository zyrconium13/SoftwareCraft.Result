...
public sealed class Result2Lifting3Tests
{
  #region Lift
...
public sealed class Result2_Lift3ErrorTestData : IEnumerable<object[]>
{
...
public sealed class Result2_LiftLazy3ErrorTestData : IEnumerable<object[]>
{
...
public sealed class Result2_LiftAsync3ErrorTestData : IEnumerable<object[]>
{
...
public sealed class Result2_LiftLazyAsync3ErrorTestData : IEnumerable<object[]>
{
