...
public sealed class Result1Lifting4Tests
{
  #region Lift
...
public sealed class Result1_Lift4ErrorTestData : IEnumerable<object[]>
{
...
public sealed class Result1_LiftAsync4ErrorTestData : IEnumerable<object[]>
{
...
public sealed class Result1_LiftLazy4ErrorTestData : IEnumerable<object[]>
{
...
public sealed class Result1_LiftLazyAsync4ErrorTestData : IEnumerable<object[]>
{
